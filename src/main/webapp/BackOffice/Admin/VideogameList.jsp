                ...
                <tr>
                    ...
                    <td>
                        <form action="<c:url value="/controller/VideogamesControl"/>" method="post">
                            <button style="display:none" type=button onclick="ajaxPetition(${company.company_id_pk})" class="btn btn-danger " data-toggle="modal" data-target="#videogameModal"><i class="fa fa-pencil" aria-hidden="true"></i></button>
