         ...
         <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <div class="row">
                        <div class="col">
                            <ul id="user-list-nav" class="nav nav-tabs" role="tablist">

                                <li class="nav-item">
                                    <a class="nav-link active" href="#completed" id="completed-tab" role="tab"
                                       data-toggle="tab" aria-controls="completed" aria-expanded="true">Juegos Completados</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#process" id="process-tab" role="tab"
                                       data-toggle="tab" aria-controls="process" aria-expanded="true">Juegos en proceso</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#dropped" id="dropped-tab" role="tab"
                                       data-toggle="tab" aria-controls="dropped" aria-expanded="true">Juegos dropeados</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#pending" id="pending-tab" role="tab"
                                       data-toggle="tab" aria-controls="pending" aria-expanded="true">Juegos pendientes</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="#favorite" id="favorite-tab" role="tab"
                                       data-toggle="tab" aria-controls="favorite" aria-expanded="true">TOP juegos favoritos</a>
                                </li>
